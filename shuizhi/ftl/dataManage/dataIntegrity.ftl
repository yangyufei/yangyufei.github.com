...
<head>
    ...
    <!--页面特有css-->
    <link rel="stylesheet" type="text/less" href="${basePath}/css/dataManage/dataIntegrity.less">
    ...
    <!-- 页面特有js -->
    <script type="text/javascript" src="../../js/dataManage/dataIntegrity.js"></script>
</head>
<body>
<div class="wrap">
    ...
    <div class="wrap-con">
        ...
        <div class="wrapCon">
            <div class="nowAddr clearfix">
                <span>当前位置：</span>
                <p><a href="#" class="contentName">白马河站</a>&nbsp;/&nbsp;<var class="navName">数据完整性统计</var></p>
            </div>
...
<<<<<<< .mine
<!-- 页面特有js -->
<script type="text/javascript" src="${basePath}/js/dataManage/dataIntegrity.js"></script>
=======
