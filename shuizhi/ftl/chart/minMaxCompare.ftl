...
<head>
    ...
    <!--页面特有css-->
    <link rel="stylesheet" type="text/less" href="${basePath}/css/chart/minMaxCompare.less">
    ...
    <!-- 页面特有js -->
    <script type="text/javascript" src="${basePath}/js/chart/minMaxCompare.js"></script>
</head>
<body>
<div class="wrap">
    ...
    <div class="wrap-con">
        ...
        <div class="wrapCon">
            <div class="nowAddr clearfix">
                <span>当前位置：</span>
                <p><a href="#" class="contentName"><var class="navName">最大最小值对比图</var></p>
            </div>
                        ...
                        <form class="form-inline screenCon">
                            <div class="form-line-wrap">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="paramsChoose" class="selectpicker min-select">
